...
// CATEGORY FROM URL
// Example:
// results.html?category=SUB%20JUNIOR
// ------------------------------------------------------
...
document.title = CATEGORY + " Results";
...
renderRanking(filteredRows);

renderEvents(filteredRows);

renderPointTable(filteredRows);
...
'<div class="waiting">Unable to load results.</div>';
...
document.getElementById("events").innerHTML=
'<div class="waiting">No events found.</div>';
